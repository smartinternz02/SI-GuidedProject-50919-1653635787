...
API_KEY = "v_YyRpwhrZPsOzbx3v5ZZnfhX4lBkKrDwogNzTN4dlTo"
...
def pred():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/f425f6b9-512b-419c-b888-a947e464b9de/predictions?version=2022-03-08', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
